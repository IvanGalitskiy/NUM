package com.vallsoft.num.ui.masked_edit_text;
...
//            String mask = getMask();
//            setMask("");
//            rawText = new RawText(phone.substring(2, phone.length()));
//            setText(makeMaskedText());
//            setMask(mask);
//            setKeepHint(true);
//        }
        if (phone!=null) {
            setText(phone.substring(1,phone.length()));
        }
    }
